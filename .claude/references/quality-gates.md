...
> Coding style/formatting rules -> `.claude/rules/coding-rules.md`, `.claude/rules/code-style.md`
> Testing rules -> `.claude/rules/testing-standards.md`
...
- Dangerous commands: `.claude/hooks/block-dangerous-commands.js`
