...
description: "Explicit-only Spec Kit adapter: use only when the user invokes $speckit-checklist; generate a custom checklist for the current feature based on user requirements."
