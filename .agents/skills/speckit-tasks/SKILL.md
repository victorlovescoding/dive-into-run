---
name: "speckit-tasks"
description: "Explicit-only Spec Kit adapter: use only when the user invokes $speckit-tasks; generate an actionable, dependency-ordered tasks.md for the feature based on available design artifacts."
