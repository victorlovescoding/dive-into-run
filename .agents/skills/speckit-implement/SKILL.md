...
description: "Explicit-only Spec Kit adapter: use only when the user invokes $speckit-implement; execute the implementation plan by processing and executing all tasks defined in tasks.md"
...
Repo-changing implementation must be dispatched to Engineer and reviewed and
verified before completion claims. Do not write files or mark tasks complete
unless the active authorization boundary includes that write.
