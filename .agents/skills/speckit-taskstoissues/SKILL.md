...
description: "Explicit-only Spec Kit adapter: use only when the user invokes $speckit-taskstoissues; convert existing tasks into actionable, dependency-ordered GitHub issues for the feature based on available design artifacts."
