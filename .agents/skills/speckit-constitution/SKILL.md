...
description: "Explicit-only Spec Kit adapter: use only when the user invokes $speckit-constitution; create or update the project constitution from interactive or provided principle inputs, ensuring all dependent templates stay in sync."
